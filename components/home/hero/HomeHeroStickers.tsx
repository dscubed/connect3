...
export function HomeHeroStickers() {
  return (
    <div className="pointer-events-none absolute inset-0 z-[0]">
      ...
      <div className="absolute -left-8 -top-4 w-[160px] md:left-[16%] md:top-0 md:w-[220px] lg:w-[260px] aspect-[651/416]">
        <Image
      ...
      <div className="absolute hidden md:block left-[7%] bottom-0 w-[160px] lg:w-[200px] aspect-square">
        <Image
      ...
      <div className="absolute hidden md:block left-[74.5%] bottom-0 w-[180px] lg:w-[240px] aspect-[644/476]">
        <Image
      ...
      <div className="absolute -right-6 -top-4 w-[140px] md:right-0 md:top-[5%] md:w-[170px] lg:w-[210px] aspect-[278/304] z-20">
        <Image
