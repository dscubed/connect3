...
export function HomeSearchBar({ className }: HomeSearchBarProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className={cn("w-full", className)}>
      <div className="flex items-center gap-3 rounded-full bg-white/90 border border-white/70 shadow-[0_14px_32px_-20px_rgba(40,20,80,0.55)] px-4 py-3 backdrop-blur-sm">
        <input
          type="text"
          value={query}
