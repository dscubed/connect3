  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md overflow-y-auto max-h-[90vh]">
        <div className="p-6">
          <h2 className="text-2xl font-bold mb-4">Setup Humanitix Integration</h2>
          
          <p className="mb-3 text-sm">
            To reduce your workload, we support an automatic event synchronisation system.
            Any events you create on Humanitix will be automatically uploaded to Connect3 - no extra work required.
          </p>
