  ...
  return (
    <>
      <div className="pointer-events-none absolute inset-0 z-10">
        <div className="absolute left-[16%] top-0 w-[clamp(90px,18%,300px)] aspect-[651/416]">
          <Image
        ...
        <div className="absolute left-[7%] bottom-0 w-[clamp(70px,15%,230px)] aspect-square">
        ...
        <div className="absolute left-[74.5%] bottom-0 w-[clamp(90px,16%,300px)] aspect-[644/476]">
          <Image
        ...
        <div className="absolute right-0 top-[5%] w-[clamp(70px,14%,240px)] aspect-[278/304] z-20">
          <Image
